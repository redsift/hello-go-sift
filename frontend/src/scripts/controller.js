/**
 * Hello Go Sift. Frontend controller entry point.
 */
...
export default class MyController extends SiftController {
  ...
  loadView(state) {
    console.log('hello-go-sift: loadView', state);
    ...
    switch (state.type) {
      ...
      default:
        console.error('hello-go-sift: unknown Sift type: ', state.type);
    }
  }

  // Event: storage update
  // onStorageUpdate(value) {
  //   console.log('hello-go-sift: onStorageUpdate: ', value);
  ...
  //     bucket: 'x'
  //   }).then((values) => {
  //     console.log('hello-go-sift: getX returned:', values);
  //     return {};
  //   });
  // }
